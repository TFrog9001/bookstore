...
if (isset($_POST['key']) && $_POST['key'] != '') {
    ...
    $sql_sp = mysqli_query($conn, "select * from sach s left join danhmucsach dm on s.id_dm = dm.id_dm 
                                                    where s.tinhtrang = 1 and (LCASE(s.ten_sach) like '%$key%'
                                                                               or LCASE(dm.ten_dm) like '%$key%')
                                                                               or LCASE(s.ten_tg) like '%$key%'" );
        ...
        <div id="main-breadcrumb" class="border border-light-subtle px-4 my-3 pt-2" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item  active" aria-current="page">
                    <?php echo 'Kết quả tìm kiếm cho "'.$key.'"' ?>
                </li>
            </ol>
        </div>
        <!-- San pham -->
                            ...
                            <div class="col-md-3 col-6">
                                <div class="card my-2 text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="./index.php?quanly=themsp" method="post">
